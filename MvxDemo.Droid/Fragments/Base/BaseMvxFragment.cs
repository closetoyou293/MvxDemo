...
namespace MvxDemo.Droid.Fragments.Base
{
    public abstract class BaseMvxFragment<TViewModel, TInitParams> : BaseMvxFragment<TViewModel> where TViewModel : BaseApplicationMvxViewModel<TInitParams> where TInitParams : class 
    {
